        ...
        <Row>
          ...
          <Col lg="5" md="9" className="wrap-feature30-box">
            <Card className="card-shadow">
              <CardBody>
                <div className="p-10">
                  <h3 className="title text-center">¿Quienes Somos?</h3>
                  <div className="subtitle text-justify">
                    Es una empresa subsidiaria de GB97 limite, la cual es una
                    empresa multinacional creada para abarcar el conocimiento y
