...
const Banner2 = () => {
  return (
    <div className="static-slider-head banner2">
      <Container>
        <Row className="">
          <Col lg="6" md="6" sm='5' xs='12' className="align-self-center">
            <h1 className="title">
            ...
            <div className="image-iso d-flex justify-content-end mr-5 pt-3 justify-content-xs-center">
              <Image src={iso} alt="Logo ISO" width={250} height={120}/>            
            </div>
          </Col>
          <Col lg="6" md="6" sm='5' xs={{size: 'auto'}}>
